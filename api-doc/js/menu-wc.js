                            ...
                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#directives-links-module-AngularDraggableModule-68a6b94c6b113686fba9a742b8c42a41"' : 'data-target="#xs-directives-links-module-AngularDraggableModule-68a6b94c6b113686fba9a742b8c42a41"' }>
                                        <span class="icon ion-md-code-working"></span>
                                        <span>Directives</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="directives-links-module-AngularDraggableModule-68a6b94c6b113686fba9a742b8c42a41"' :
                                        'id="xs-directives-links-module-AngularDraggableModule-68a6b94c6b113686fba9a742b8c42a41"' }>
                                        <li class="link">
                                            <a href="directives/AngularDraggableDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">AngularDraggableDirective</a>
                                        </li>
                                        <li class="link">
                                            <a href="directives/AngularResizableDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">AngularResizableDirective</a>
                                        </li>
                                    </ul>
                                </li>
                            </li>
